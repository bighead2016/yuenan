...
%% @return ok
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
write_erl_file(List, FileRootName) ->
    try
        {ok, 
        ...
        file:make_dir("../yrl/" ++ ModName),
        {ok, Fd} = open_file(lists:concat(["../yrl/", ModName, "/", YrlName, ".yrl"])),
