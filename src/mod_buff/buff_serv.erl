...
make_unique_id_call() ->
	gen_server:call(?MODULE, make_buff_id, ?CONST_TIMEOUT_CALL).
%% ====================================================================
%% Server functions
%% ====================================================================
...
%%% Internal functions
%% --------------------------------------------------------------------
do_call(make_buff_id, _From, State = #state{buff_id = MakeId}) ->
    if
        MakeId =< 4294967295 ->
            {?reply, MakeId, State#state{buff_id = MakeId + 1}};
        ?true ->
            {?reply, MakeId, State#state{buff_id = 1}}
    end;
